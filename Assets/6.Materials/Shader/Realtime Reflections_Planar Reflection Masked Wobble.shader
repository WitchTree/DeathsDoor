...
//
///////////////////////////////////////////
Shader "Realtime Reflections/Planar Reflection Masked Wobble" {
Properties {
...
_NoiseTint ("Noise Tint Color (RGB)", Color) = (1,1,1,1)
_NoisePercent ("Reflection Tint Percent", Range(0, 1)) = 0
_MainTex ("MainTex (RGBA)", 2D) = "" { }
_WobbleTex ("Wobble (RGBA)", 2D) = "" { }
