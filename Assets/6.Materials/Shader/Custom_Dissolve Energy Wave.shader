...
//
///////////////////////////////////////////
Shader "Custom/Dissolve Energy Wave" {
Properties {
...
"// shader disassembly not supported on DXBC"
 ...
 Pass {
  Name "FORWARD"
  LOD 200
  Tags { "LIGHTMODE" = "FORWARDADD" "RenderType" = "Transparent" "SHADOWSUPPORT" = "true" }
...
"// shader disassembly not supported on DXBC"
 ...
 Pass {
  Name "ShadowCaster"
  LOD 200
  Tags { "LIGHTMODE" = "SHADOWCASTER" "RenderType" = "Transparent" "SHADOWSUPPORT" = "true" }
  GpuProgramID 389721
Program "vp" {
SubProgram "d3d11 " {
